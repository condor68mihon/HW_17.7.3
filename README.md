Программа выводит накопленные средства за год для каждого банка (deposit) и максимальное значение из накопленных средств, в зависимости
от вложенных средств (money)

# HW_17.7.3
Основы Python_mod17_HW_17.7.3
